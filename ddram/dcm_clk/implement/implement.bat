...
xst -ifn xst.scr
move dcm_clk_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\dcm_clk.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc dcm_clk.ucf dcm_clk_exdes

echo 'Running map'
map -timing -pr b dcm_clk_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm dcm_clk_exdes -w routed.ncd routed.vhd
cd ..
