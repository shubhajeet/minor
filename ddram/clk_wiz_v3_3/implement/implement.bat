...
xst -ifn xst.scr
move clk_wiz_v3_3_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\clk_wiz_v3_3.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clk_wiz_v3_3.ucf clk_wiz_v3_3_exdes

echo 'Running map'
map -timing -pr b clk_wiz_v3_3_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm clk_wiz_v3_3_exdes -w routed.ncd routed.vhd
cd ..
